# Trigger.dev v4 Rules (vendor reference)

Moved out of CLAUDE.md on 2026-07-05 to keep the entry point light. Same guidance is available as skills in .claude/skills/trigger-*.
